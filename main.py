...
def getResultado(id):
    ...
    return jsonify(json)
#AÑADIR RESULTADO EN UNA MESA
@app.route("/resultados/mesas/<string:id_mesa>/candidato/<string:id_candidato>",methods = ["POST"])
def crearResultado(id_mesa, id_candidato):
    data = request.get_json()
    json = miControladorResultado.create(data, id_mesa, id_candidato)
    return jsonify(json)
#MODIFICAR EL RESULTADO
@app.route("/resultados/<string:id_resultado>/mesas/<string:id_mesa>/candidato/<string:id_candidato>",methods = ["PUT"])
def modificarResultado(id_mesa, id_candidato, id_resultado):
    data = request.get_json()
